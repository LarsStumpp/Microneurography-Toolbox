...
for j = 1:5: ceil(length(tmp)/5)*5 %%%% floor
    if j <= length(tmp)
        burst_plot1 = [burst_plot1;[(t_msna(app.burst_res.burst_loc(tmp(j),1):app.burst_res.burst_loc(tmp(j),2)))',...
                       (app.burst_res.x(app.burst_res.burst_loc(tmp(j),1):app.burst_res.burst_loc(tmp(j),2)))'];...%(app.burst_res.htresh +app.burst_res.xshift(app.burst_res.burst_loc(tmp(j),1):app.burst_res.burst_loc(tmp(j),2)))'];...
                       [t_msna(app.burst_res.burst_loc(tmp(j),1)), app.burst_res.x(app.burst_res.burst_loc(tmp(j),1))];...%[t_msna(app.burst_res.burst_loc(tmp(j),1)), app.burst_res.htresh+app.burst_res.xshift(app.burst_res.burst_loc(tmp(j),1))];...
                       [nan,nan]];
    ...
    if j+1 <= length(tmp)   
        burst_plot2 = [burst_plot2;[(t_msna(app.burst_res.burst_loc(tmp(j+1),1):app.burst_res.burst_loc(tmp(j+1),2)))',...
                       (app.burst_res.x(app.burst_res.burst_loc(tmp(j+1),1):app.burst_res.burst_loc(tmp(j+1),2)))'];...%(app.burst_res.htresh +app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+1),1):app.burst_res.burst_loc(tmp(j+1),2)))'];...
                       [t_msna(app.burst_res.burst_loc(tmp(j+1),1)), app.burst_res.x(app.burst_res.burst_loc(tmp(j+1),1))];...%[t_msna(app.burst_res.burst_loc(tmp(j+1),1)), app.burst_res.htresh+app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+1),1))];...
                       [nan,nan]];
    ...
    if j+2 <= length(tmp)
        burst_plot3 = [burst_plot3;[(t_msna(app.burst_res.burst_loc(tmp(j+2),1):app.burst_res.burst_loc(tmp(j+2),2)))',...
                       (app.burst_res.x(app.burst_res.burst_loc(tmp(j+2),1):app.burst_res.burst_loc(tmp(j+2),2)))'];...%(app.burst_res.htresh +app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+2),1):app.burst_res.burst_loc(tmp(j+2),2)))'];...
                       [t_msna(app.burst_res.burst_loc(tmp(j+2),1)), app.burst_res.x(app.burst_res.burst_loc(tmp(j+2),1))];...%[t_msna(app.burst_res.burst_loc(tmp(j+2),1)), app.burst_res.htresh+app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+2),1))];...
                       [nan,nan]];
    ...
    if j+3 <= length(tmp)
        burst_plot4 = [burst_plot4;[(t_msna(app.burst_res.burst_loc(tmp(j+3),1):app.burst_res.burst_loc(tmp(j+3),2)))',...
                       (app.burst_res.x(app.burst_res.burst_loc(tmp(j+3),1):app.burst_res.burst_loc(tmp(j+3),2)))'];...%(app.burst_res.htresh +app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+3),1):app.burst_res.burst_loc(tmp(j+3),2)))'];...
                       [t_msna(app.burst_res.burst_loc(tmp(j+3),1)), app.burst_res.x(app.burst_res.burst_loc(tmp(j+3),1))];...%[t_msna(app.burst_res.burst_loc(tmp(j+3),1)), app.burst_res.htresh+app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+3),1))];...
                       [nan,nan]];
    ...
    if j+4 <= length(tmp) 
        burst_plot5 = [burst_plot5;[(t_msna(app.burst_res.burst_loc(tmp(j+4),1):app.burst_res.burst_loc(tmp(j+4),2)))',...
                       (app.burst_res.x(app.burst_res.burst_loc(tmp(j+4),1):app.burst_res.burst_loc(tmp(j+4),2)))'];...%(app.burst_res.htresh +app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+4),1):app.burst_res.burst_loc(tmp(j+4),2)))'];...
                       [t_msna(app.burst_res.burst_loc(tmp(j+4),1)), app.burst_res.x(app.burst_res.burst_loc(tmp(j+4),1))];...%[t_msna(app.burst_res.burst_loc(tmp(j+4),1)), app.burst_res.htresh+app.burst_res.xshift(app.burst_res.burst_loc(tmp(j+4),1))];...
                       [nan,nan]];
...
for j = 1:length(tmp_rem) 
    burst_plot_rem = [burst_plot_rem;[(t_msna(app.burst_res.burst_loc(tmp_rem(j),1):app.burst_res.burst_loc(tmp_rem(j),2)))',...
                   (app.burst_res.x(app.burst_res.burst_loc(tmp_rem(j),1):app.burst_res.burst_loc(tmp_rem(j),2)))'];...%(app.burst_res.htresh +app.burst_res.xshift(app.burst_res.burst_loc(tmp_rem(j),1):app.burst_res.burst_loc(tmp_rem(j),2)))'];...
                   [t_msna(app.burst_res.burst_loc(tmp_rem(j),1)), app.burst_res.x(app.burst_res.burst_loc(tmp_rem(j),1))];...%[t_msna(app.burst_res.burst_loc(tmp_rem(j),1)), app.burst_res.htresh+app.burst_res.xshift(app.burst_res.burst_loc(tmp_rem(j),1))];...
                   [nan,nan]];
...
EE.inter_burst_interval = diff(app.burst_res.t_burst(burst_idx));%app.burst_res.dt_burst(burst_idx(1:end-1));
